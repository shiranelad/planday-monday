...
function connectSockets(http, session) {
    ...
    gIo.on('connection', socket => {
        ...
        // })
        socket.on('board saved', boardId => {
            console.log('Emitting update added', boardId);
        ...
        socket.on('item dragged', msg => {
            console.log('Emitting item ', msg);
            gIo.emit('board changed', msg);
        });
